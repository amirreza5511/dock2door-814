...
export function buildDeliveredBolHtml(shipment: ShipmentInfo, pieces: PieceInfo[], delivery: DeliveryInfo): string {
  ...
  <style>
    * { box-sizing: border-box; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
    ...
    .sig-box { border-bottom: 2px solid #0b0f17; padding: 6px; min-height: 90px; background: #fff; border-radius: 8px; display: flex; align-items: center; justify-content: center; }
