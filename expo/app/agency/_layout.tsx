...
import { LayoutDashboard, CalendarSearch, Users, Building2, Receipt } from 'lucide-react-native';
...
export default function AgencyLayout() {
  ...
  return (
    ...
    >
      ...
      <Tabs.Screen name="shifts" options={{ title: 'Open Shifts', tabBarIcon: ({ color }) => <CalendarSearch size={22} color={color} /> }} />
      <Tabs.Screen name="workers" options={{ title: 'Workers', tabBarIcon: ({ color }) => <Users size={22} color={color} /> }} />
      <Tabs.Screen name="clients" options={{ title: 'Clients', tabBarIcon: ({ color }) => <Building2 size={22} color={color} /> }} />
