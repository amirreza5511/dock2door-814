...
import { ArrowLeft, CalendarClock, Clock, MapPin, Package, Plus, Ship, Train, Truck, X, Zap, Anchor } from 'lucide-react-native';
...
export default function CustomerDrayageScreen() {
  ...
  const yardTerminals = useMemo(() => terminals.filter((t) => t.terminal_type === 'Yard' || t.terminal_type === 'Depot'), [terminals]);
    ...
    <View style={[styles.root, { backgroundColor: C.bg }]}>
      <View style={[styles.header, { paddingTop: insets.top + 16 }]}>
        ...
        <View style={{ flex: 1 }}>
          ...
          <Text style={styles.headerSub}>Post import/export container orders</Text>
        </View>
      </View>
      ...
      >
        ...
        {ordersQuery.isLoading ? (
          ...
          <Card
            key={o.id}
            onPress={() => router.push({ pathname: '/customer/drayage/[orderId]', params: { orderId: o.id } } as never)}
