...
import { Building2, Users, AlertTriangle, CheckCircle, Clock, DollarSign, ShieldCheck, LogOut, Award, Truck, Tag, HelpCircle, Briefcase, Globe } from 'lucide-react-native';
        ...
        <View style={styles.section}>
          ...
          <View style={styles.navGrid}>
            {[
              ...
              { label: 'Freight Review', icon: Globe, route: '/admin/freight-review', color: C.blue },
              { label: 'Sales & Commissions', icon: Briefcase, route: '/admin/sales-agents', color: C.orange },
