  ...
  return (
    <View style={[styles.root, { backgroundColor: C.bg }]}>
      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={[styles.scroll, { paddingBottom: insets.bottom + 100 }]} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          <Card onPress={() => router.push('/warehouse-provider/hub-freight' as any)} elevated>
            <View style={styles.createRow}>
              <View style={[styles.createIcon, { backgroundColor: C.accentDim }]}>
                <ArrowDownToLine size={22} color={C.accent} />
              </View>
              <View style={{ flex: 1 }}>
                <Text style={styles.createTitle}>Network Hub Freight</Text>
                <Text style={styles.createDesc}>Check in inbound loads, manage storage & release for delivery</Text>
              </View>
            </View>
          </Card>
          <Card onPress={() => router.push('/marketplace' as any)} elevated style={{ marginTop: 10 }}>
            <View style={styles.createRow}>
