...
import { LayoutDashboard, Warehouse, BookOpen, PlusCircle, Receipt } from 'lucide-react-native';
...
export default function WarehouseProviderLayout() {
  return (
    ...
    >
      ...
      <Tabs.Screen name="create-listing" options={{ title: 'New Listing', tabBarIcon: ({ color }) => <PlusCircle size={22} color={color} /> }} />
