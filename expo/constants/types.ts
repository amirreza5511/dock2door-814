export type UserRole = 'Customer' | 'WarehouseProvider' | 'ServiceProvider' | 'Employer' | 'Worker' | 'TruckingCompany' | 'Driver' | 'GateStaff' | 'Shipper' | 'DrayageCompany' | 'FreightForwarder' | 'EquipmentRentalCompany' | 'MobileRepairProvider' | 'CargoInsurer' | 'MarketplaceBuyer' | 'SalesAgent' | 'EmploymentAgency' | 'Admin' | 'SuperAdmin';
...
export type CompanyType = 'Customer' | 'WarehouseProvider' | 'ServiceProvider' | 'Employer' | 'TruckingCompany' | 'Shipper' | 'DrayageCompany' | 'FreightForwarder' | 'EquipmentRentalCompany' | 'MobileRepairProvider' | 'CargoInsurer' | 'MarketplaceBuyer' | 'EmploymentAgency';
