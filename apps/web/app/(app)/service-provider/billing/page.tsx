...
export default function ServiceProviderBillingPage() {
  ...
  const invoicesQ = useQuery({
    queryKey: ["service-provider", "billing", "invoices"],
    queryFn: async () => {
    ...
    <div className="mx-auto max-w-5xl space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Stripe Connect status, invoices, and payouts for your service business.
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Connect your Stripe account to receive payouts from completed service jobs.
          </CardDescription>
        </CardHeader>
