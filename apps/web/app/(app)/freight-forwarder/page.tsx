...
import { Ship, Container, FileText } from "lucide-react";
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">Every container move you&apos;ve arranged, with live status.</p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-4">
        ...
        <Stat icon={<FileText className="h-5 w-5 text-primary" />} value={String(stats.inProgress)} label="In progress" />
