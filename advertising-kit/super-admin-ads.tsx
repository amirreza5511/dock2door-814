...
const styles = StyleSheet.create({
  ...
  billingBlock: { backgroundColor: C.card, borderWidth: 1, borderColor: C.border, borderRadius: 14, padding: 12, marginBottom: 12, gap: 10 },
  billingHeading: { fontSize: 13, fontWeight: '800' as const, color: C.text },
  pmSeg: { flex: 1, minWidth: 96, alignItems: 'center', backgroundColor: C.bgSecondary, borderWidth: 1, borderColor: C.border, borderRadius: 10, paddingHorizontal: 8, paddingVertical: 10 },
  pmSegLabel: { fontSize: 12, fontWeight: '700' as const, color: C.textSecondary, textAlign: 'center' },
  pmSegSub: { fontSize: 10, fontWeight: '600' as const, color: C.textMuted, marginTop: 2 },

  activeRow: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: C.card, borderWidth: 1, borderColor: C.border, borderRadius: 12, padding: 12, marginBottom: 4 },
  activeLabel: { fontSize: 14, fontWeight: '700' as const, color: C.text },
  activeSub: { fontSize: 12, color: C.textSecondary, marginTop: 1 },
  ...
  pricingTagText: { fontSize: 10, fontWeight: '800' as const, color: C.accent },
  rateText: { fontSize: 12, fontWeight: '700' as const, color: C.text },
  budgetText: { fontSize: 11, color: C.textMuted },
  spendGrid: { flexDirection: 'row', gap: 8 },
  spendCell: { flex: 1, backgroundColor: C.card, borderRadius: 10, paddingVertical: 8, alignItems: 'center' },
  spendVal: { fontSize: 13, fontWeight: '800' as const, color: C.text },
  spendKey: { fontSize: 9.5, fontWeight: '600' as const, color: C.textMuted, marginTop: 2 },
  settledText: { fontSize: 11.5, fontWeight: '600' as const, color: C.textMuted, textAlign: 'center' },

  linkClicksRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 6 },
  linkClickPill: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: C.accentDim, borderRadius: 8, paddingHorizontal: 8, paddingVertical: 4 },
  linkClickLabel: { fontSize: 10.5, fontWeight: '600' as const, color: C.accent },
  linkClickCount: { fontSize: 10.5, fontWeight: '800' as const, color: C.accent },
});
